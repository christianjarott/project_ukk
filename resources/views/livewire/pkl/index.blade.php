                ...
                @if ($pklList && $pklList->count())
                    @foreach ($pklList as $pkl)
                        <tr class="border-b hover:bg-gray-50 transition duration-200">
                            ...
                            <td class="px-6 py-3">{{ $pkl->industri ? $pkl->industri->nama : 'Tidak ada siswa' }}</td>
                            <td class="px-6 py-3">{{ $pkl->guru ? $pkl->guru->nama : 'Tidak ada siswa' }}</td>
                            <td class="px-6 py-3">{{ $pkl->masuk }}</td>
                            <td class="px-6 py-3">{{ $pkl->keluar }}</td>
